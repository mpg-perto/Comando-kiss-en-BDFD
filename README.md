...
El comando valida que se haya mencionado a alguien, que no sea el propio autor, y que no sea un bot. Si todo es correcto, llama a `https://nekos.best/api/v2/kiss`, arma un contenedor CV2 con el gif, el nombre del anime y dos botones.
